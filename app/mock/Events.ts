...
export const Categories = [
    { category: 'Artes e intereses', type:'ARTE', options: ['Arte', 'Cultura', 'Música', 'Pintura', 'Teatro', 'Actuación', 'Danza', 'Escritura', 'Poesía'] },
    { category: 'Deportes',type:'GYM', options: ['Fútbol', 'Basket', 'Tenis', 'Yoga', 'Running', 'Salud'] },
    { category: 'Social y estilo de vida',type:'SOCIAL', options: ['Comida', 'Viajes', 'Salidas', 'Cultura', 'Moda', 'Tendencias', 'Meditación', 'Bienestar'] },
    { category: 'Tecnología', type:'TECNOLOGY',options: ['Desarrollo', 'Virtual', 'Ciberseguridad', 'Hacking', 'IA', 'Machine Learning', 'Blockchain', 'Criptomonedas', 'Programación', 'Web'] }
];
